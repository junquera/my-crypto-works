msg = '''Owpty&c\%l, §&l&ó$ n hk&\%k&rqrtl
...
F\%k§qe&ó$ rtly&$qrq qs htkl\%$qs rt sq Ar§&$&lykqe&ó$ tlhte
&qs&lyq t$ ts eq§h\% rt sq lt*xk&rqr TIC, qs \%wpty\% rt zqe&s&yqk sq qeyxqs&mqe&ó$ rt e\%$\%e&§&t$y\%l n rt s\%*kqk sq lt$l&w&s&mqe&ó$ n §tp\%kq rt lxl eqhqe&rqrtl hqkq sq rtytee&ó$ n *tly&ó$ rt &$e&rt$ytl.
...
for s in range(len(sorted_freq)):
    sorted_freq[s] = (sorted_freq[s][0], float(sorted_freq[s][1])/len(msg))
